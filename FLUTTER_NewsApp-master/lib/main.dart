  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          child: ListView(
            ...
            children: <Widget>[
              Column(
                ...
                children: [
                  if (country != null) Text("Ülke = $cName") else Container(),
                  const SizedBox(height: 10),
                  if (catagory != null)
                    Text("Kategori = $catagory")
                  else
                    Container(),
              ...
              ListTile(
                title: TextFormField(
                  decoration:
                      const InputDecoration(hintText: " Anahtar Kelime"),
        ...
        appBar: AppBar(
          centerTitle: true,
          title: const Text("Haber Günlüğü"),
          actions: [
            IconButton(
              onPressed: () {
                country = null;
        ...
        body: notFound
            ? const Center(
                child: Text("Bulunamadı.", style: TextStyle(fontSize: 30)),
              )
            : news.isEmpty
                ? const Center(
